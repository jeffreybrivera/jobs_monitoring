...
<div class="flex items-center justify-center min-h-screen">
    <form method="POST" action=" {{ route('register.attempt') }} " class="max-w-md mx-auto">
        ...
        <div>
            <label for="countries" class="block mb-2.5 text-sm font-medium text-heading">Select a Country</label>
            <select id="countries" name="countries" class="block w-full px-3 py-2.5 bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-brand focus:border-brand shadow-xs placeholder:text-body">
        ...
        <div class="mt-5">
            <label for="countries" class="block mb-2.5 text-sm font-medium text-heading">Select a City</label>
            <select id="city" name="city" class="block w-full px-3 py-2.5 bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-brand focus:border-brand shadow-xs placeholder:text-body">
                <option selected>Choose a City</option>
                <option value="US">Cebu</option>
                <option value="US">Mandue</option>
                <option value="CA">Lapu-Lapu</option>
                <option value="FR">Mandaue</option>
                <option value="DE">Consolacion</option>
            </select>
        </div>
        <button type="submit" class="text-white border-none bg-blue-500 hover:bg-blue-700 leading-5 mt-7 py-3 px-7 rounded-md text-md focus:outline-none">Submit</button>
    </form>
</div>    
